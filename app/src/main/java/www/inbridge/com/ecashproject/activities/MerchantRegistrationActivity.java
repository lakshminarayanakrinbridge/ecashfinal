...
public class MerchantRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String emailid1 = sharedPreferences.getString(Sharedpref.EMAILID_SHARED_PREF, "emailid");
    ...
    private void getData(){
        ...
        StringRequest stringRequest = new StringRequest(Url.CATEGORY_URL,
    ...
    public void onClickCreateterminal(View v) {
        Intent i = new Intent(MerchantRegistrationActivity.this, CreateTerminalActivity.class);
        startActivity(i);
    ...
    {
        Intent i = new Intent(MerchantRegistrationActivity.this, CreateTerminalOneActivity.class);
        startActivity(i);
    }
    ...
    public void onClickSubmitbutton(View v) {
        ...
        if(Long.toString(category_id).equals("0"))
        {
            ...
            accountnameEdittext.setHint("please enter Account name");
                ...
                (
                (sharedPreferences.getString(Sharedpref.LATITUDE_SHARED_PREF, "lat").equals("lat")) ||( sharedPreferences.getString(Sharedpref.LONGITUDE_SHARED_PREF, "lng").equals("lng")))
        {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Url.DATA_URL,
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    String mobilenumber1 = sharedPreferences.getString(Sharedpref.MOBILENUMBER_SHARED_PREF, "mobilenumber");
                    String emailid1 = sharedPreferences.getString(Sharedpref.EMAILID_SHARED_PREF, "emailid");
                    SharedPreferences sharedPreferences1=MerchantRegistrationActivity.this.getSharedPreferences(Sharedpref.SHARED_PREF_NAME,Context.MODE_PRIVATE);
                    ...
                    params.put("lat",sharedPreferences.getString(Sharedpref.LATITUDE_SHARED_PREF,"lat"));
                    params.put("lng",sharedPreferences.getString(Sharedpref.LONGITUDE_SHARED_PREF,"lng"));
                    params.put("mer_type","0");
                    params.put("category_list",Long.toString(category_id));
                    if(sharedPreferences1.getString(Sharedpref.KEY_CASHIERNAME1,"cashiername1").equalsIgnoreCase("cashiername1"))
                    {

                    }
                    else {
                        params.put(Sharedpref.TERMINAL1_CASHIERNAME, sharedPreferences1.getString(Sharedpref.KEY_CASHIERNAME1, "cashiername1"));
                        params.put(Sharedpref.TERMINAL1_MOBILENUMBER, sharedPreferences1.getString(Sharedpref.KEY_CASHIERMOBILE1, "cashiermobile1"));
                        params.put(Sharedpref.TERMINAL1_EMAILID, sharedPreferences1.getString(Sharedpref.KEY_CASHIEREMAIL1, "cashieremail1"));
                    }
                    if(sharedPreferences1.getString(Sharedpref.KEY_CASHIERNAME2,"cashiername2").equalsIgnoreCase("cashiername2"))
                    {

                    }
                    else {
                        params.put(Sharedpref.TERMINAL2_CASHIERNAME, sharedPreferences1.getString(Sharedpref.KEY_CASHIERNAME2, "cashiername2"));
                        params.put(Sharedpref.TERMINAL2_MOBILENUMBER, sharedPreferences1.getString(Sharedpref.KEY_CASHIERMOBILE2, "cashiermobile2"));
                        params.put(Sharedpref.TERMINAL2_EMAILID, sharedPreferences1.getString(Sharedpref.KEY_CASHIEREMAIl2, "cashieremail2"));
                    }
