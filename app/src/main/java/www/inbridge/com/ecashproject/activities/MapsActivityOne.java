...
//, LocationListener
public class MapsActivityOne extends AppCompatActivity implements
    ...
    public void onSearch(View view)
    {
        ...
        if(locationString != null || !locationString.equals(""))
        {
            ...
            editor.putString(Sharedpref.LATITUDE_SHARED_PREF,lat );
            editor.putString(Sharedpref.LONGITUDE_SHARED_PREF, lng);
