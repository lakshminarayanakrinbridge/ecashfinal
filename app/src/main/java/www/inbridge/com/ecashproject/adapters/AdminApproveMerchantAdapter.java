...
public class AdminApproveMerchantAdapter extends RecyclerView.Adapter<AdminApproveMerchantAdapter.MyHolder> {


    private LayoutInflater inflater;
    List<AdminApproveMerchantData> admindata = new ArrayList<>();

    public AdminApproveMerchantAdapter(Context context, List<AdminApproveMerchantData> admindata) {
