...
public class MerchantEditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = MerchantEditProfileActivity.this.getSharedPreferences(Sharedpref.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        ...
        merchantnameEdittext.setText(sharedPreferences.getString(Sharedpref.MERCHANT_NAME_SHARED_PREF,"mname"));
        merchantkeyEdittext.setText(sharedPreferences.getString(Sharedpref.MERCHANT_KEY_SHARED_PREF,"mkey"));
        ...
        ifsccodeEdittext.setText(sharedPreferences.getString(Sharedpref.IFSCCODE_SHARED_PREF,"ifsccode"));
        accountnumberEdittext.setText(sharedPreferences.getString(Sharedpref.ACCOUNT_NUMBER_SHARED_PREF,"anumber"));
        accountnameEdittext.setText(sharedPreferences.getString(Sharedpref.ACCOUNT_NAME_SHARED_PREF,"aname"));
        addressEdittext.setText(sharedPreferences.getString(Sharedpref.ADDRESS_SHARED_PREF,"address"));
        kycdetailseEdittext.setText(sharedPreferences.getString(Sharedpref.KYCDETAILS_SHARED_PREF,"kycdetails"));
    }
    ...
    public void onClickSubmitbutton(View v) {
        ...
        if (merchantnameEdittext.getText().toString().trim().equals("")) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Url.EDIT_MERCHANT_URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (str2.equalsIgnoreCase("merchant updated sucessfully")) {
                                ...
                                Intent intent = new Intent(MerchantEditProfileActivity.this, MerchantProfileActivity.class);
                                ...
                                try {
                                    ...
                                    Toast.makeText(MerchantEditProfileActivity.this, str, Toast.LENGTH_LONG).show();
